...
allocate n objects of size x, release half of them, and reallocate n/2 objects of size y>x. Compare the performance (time spent in full GC, scavenging, compacting, and execution time) for both Mark-Sweep and Mark-Compact
\begin{itemize}
